...
const faqData = [
  {
    ...
    answer:
      "Wiredleap is an AI-powered development platform designed for developers, teams, and organizations who want toaccelerate their coding workflow. It's perfect for both individual developers looking to enhance their productivity and teams seeking seamless collaboration tools.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes! Wiredleap offers one-click integrations with popular development tools including GitHub, GitLab, VS Code, Slack, and many more. Our MCP connectivity allows you to easily manage and configure server access across your entire development stack.",
  },
  {
    question: "What's included in the free plan?",
    answer:
      "The free plan includes real-time code suggestions, basic integrations, single MCP server connection, up to 2 AI coding agents, and Vercel deployments with Wiredleap branding. It's perfect for individual developers getting started.",
  },
  {
...
export function FAQSection() {
  ...
  return (
    <section className="w-full pt-[66px] pb-12 md:pb-20 px-5 relative flex flex-col justify-center items-center">
